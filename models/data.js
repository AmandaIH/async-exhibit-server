...
function generateEvents() {
  return [
    ...
    },
    {
      ...
      description:
        "Kunst, der kombinerer traditionelle teknikker med moderne teknologi.",
      date: "2025-05-04",
      locationId: "2",
      curator: "Jonas B.",
      artworkIds: [
    ...
    },
    {
      ...
      description:
        "Værker, der spejler tidens kulturelle og sociale tendenser.",
      date: "2025-05-12",
      locationId: "5",
      curator: "Anna K.",
      artworkIds: ["KMSst64"],
    },
    {
      ...
      title: "Lys og Mørke",
      description:
        "En udstilling der udforsker abstrakte kunstformer gennem forskellige medier.",
      date: "2025-05-07",
      locationId: "2",
      curator: "Jonas B.",
    ...
    },
    {
      ...
      title: "Krop og Sjæl",
      description:
        "Farverige værker i bevægelse sætter fokus på dynamik og energi.",
      date: "2025-05-12",
      locationId: "8",
      curator: "Jonas B.",
    ...
    },
    {
      ...
      description:
        "En rolig, meditativ udstilling med fokus på indre refleksion.",
      date: "2025-05-11",
      locationId: "10",
      curator: "Anna K.",
    ...
    },
    {
      ...
      title: "Form og Funktion",
      description:
        "En undersøgelse af kroppen i rumlige skulpturer og installationer.",
      date: "2025-05-08",
      locationId: "1",
      curator: "Mia M.",
